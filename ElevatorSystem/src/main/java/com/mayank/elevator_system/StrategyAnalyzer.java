...
public class StrategyAnalyzer {
    ...
    public static class PerformanceMetrics {
        ...
        public PerformanceMetrics(int totalDistance, int directionChanges,
                                  double averageWaitTime, int maxWaitTime) {
        ...
        public String toString() {
            return String.format("Distance: %d, Changes: %d, Avg Wait: %.1f, Max Wait: %d",
    ...
    private static PerformanceMetrics calculateMetrics(List<Integer> serviceOrder,
                                                       List<Integer> originalRequests, int startFloor) {
        ...
        double averageWaitTime = originalRequests.isEmpty() ? 0.0 :
                (double) totalWaitTime / originalRequests.size();
