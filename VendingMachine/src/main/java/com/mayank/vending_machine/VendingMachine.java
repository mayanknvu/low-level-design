...
public class VendingMachine {
    ...
    @Setter
    private VendingMachineState currentState = selectionState;
    ...
    public double getChangeToReturn() { return changeToReturn; }
    public void setChangeToReturn(double change) { this.changeToReturn = change; }

    public VendingMachineState getSelectionState() { return selectionState; }
    public VendingMachineState getPaymentState() { return paymentState; }
    public VendingMachineState getDispenseState() { return dispenseState; }
    public VendingMachineState getIssueChangeState() { return issueChangeState; }
